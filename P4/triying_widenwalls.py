...
while True:
    ...
    while not widen_walls and gradient_done:
        ...
        for wall in widen_pixels:
            x,y = wall
            if npixel_wall == 5:
                neighbors = [(x-extended, y), (x+extended, y), (x, y-extended), (x, y+extended), (x+extended, y+extended), (x-extended, y+extended), (x+extended, y-extended), (x-extended, y-extended)]
                #frontier = neighbors
            else:
                neighbors = [(x-1, y), (x+1, y), (x, y-1), (x, y+1), (x+1, y+1), (x-1, y+1), (x+1, y-1), (x-1, y-1)]
